import random
from sklearn.metrics import jaccard_score as jaccard_similarity_score, roc_auc_score, precision_score, f1_score, average_precision_score
import numpy as np
import os
import logging
...
def metric_report(y_pred, y_true, therhold=0.5):
    ...
    acc_container['avg_p']=avg_p
    acc_container['avg_r'] = avg_r
